-- ============================================================
-- NOVO SISTEMA DE ACOMPANHAMENTO - 4 FORMULÁRIOS PROGRESSIVOS (CORRIGIDO)
-- ============================================================
...
begin
  ...
  -- Mas ainda assim retornamos a data para exibição
  return data_desbloqueio;
end;
$$;

-- ============================================================
-- FUNÇÃO PARA VERIFICAR FORMULÁRIOS DISPONÍVEIS (SIMPLIFICADA)
-- ============================================================
